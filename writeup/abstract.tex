...
confidence bound (\textlcsc{UCB1}) and $\mathcal{E}_n$-\textlcsc{greedy}. We conclude that the  $\mathcal{E}_n$-\textlcsc{greedy} policy is better than \textlcsc{UCB1} due to the
optimal arm being played more frequently and a lower regret.
